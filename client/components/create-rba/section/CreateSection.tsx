...
export const CreateSection = ({setSectionState, setSectionSelectState}: Props) => {
    ...
    <>
      <Card isBlurred className="w-full mb-5">
        ...
        <CardBody className="ml-4 mt-2 mb-3">
          <SectionForm setSectionState={setSectionState} setSectionSelectState={setSectionSelectState}/>
        </CardBody>
      </Card>
    </>
  )
